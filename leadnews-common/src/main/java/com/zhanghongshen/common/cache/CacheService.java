package com.zhanghongshen.common.cache;
...
public class CacheService {
    ...
    /**
     * Batch delete key synchronously
     *
     * @param keys
     */
    ...
    public Object executeScript(String key, String value, String script) {
    ...
    public List<Object> executePipelined(RedisCallback<?> redisCallback) {
        return stringRedisTemplate.executePipelined(redisCallback);
    }
