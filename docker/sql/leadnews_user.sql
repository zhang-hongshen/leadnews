...
-- Records of ap_user
-- ----------------------------
INSERT INTO `ap_user` VALUES ('1', 'abc', 'zhangsan', 'abc', '13511223453', null, '1', null, null, '1', '1', '2020-03-19 23:22:07', '2020-03-19 23:22:07');
INSERT INTO `ap_user` VALUES ('2', 'abc', 'lisi', 'abc', '13511223454', '', '1', null, null, '1', '1', '2020-03-19 23:22:07', '2020-03-19 23:22:07');
INSERT INTO `ap_user` VALUES ('3', 'sdsa', 'wangwu', 'wangwu', '13511223455', null, null, null, null, null, '1', '2020-03-30 16:36:32','2020-03-30 16:36:32');
INSERT INTO `ap_user` VALUES ('4', '123abc', 'admin', '81e158e10201b6d7aee6e35eaf744796', '13511223456', null, '1', null, null, '1', '1', '2020-03-30 16:36:32', '2020-03-30 16:36:32');
INSERT INTO `ap_user` VALUES ('5', '123', 'suwukong', 'suwukong', '13511223458', null, '1', null, null, '1', '1', '2020-08-01 11:09:57','2020-08-01 11:09:57');
INSERT INTO `ap_user` VALUES ('6', null, null, null, null, null, null, null, null, null, null, '2020-03-30 16:36:32', '2020-03-30 16:36:32');
...
CREATE TABLE `ap_user_fan` (
  ...
  `fans_id` bigint unsigned DEFAULT NULL COMMENT '粉丝ID',
...
CREATE TABLE `ap_user_follow` (
  `id` bigint unsigned NOT NULL PRIMARY KEY AUTO_INCREMENT,
  `user_id` bigint unsigned DEFAULT NULL COMMENT '用户ID',
  `follow_id` bigint unsigned DEFAULT NULL COMMENT '关注作者ID',
...
CREATE TABLE `ap_user_realname` (
  `id` bigint unsigned NOT NULL PRIMARY KEY AUTO_INCREMENT,
  `user_id` bigint unsigned DEFAULT NULL COMMENT '账号ID',
