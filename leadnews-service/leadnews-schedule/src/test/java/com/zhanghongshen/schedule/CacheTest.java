...
public class CacheTest {
    ...
    public  void testPiple1(){
        ...
        System.out.println("Time Cost(ms):" + (System.currentTimeMillis() - start));
    }
    ...
    public void testPiple2(){
        long start  = System.currentTimeMillis();
        //使用管道技术
        List<Object> objectList = cacheService.executePipelined(connection -> {
            for (int i = 0; i <10000 ; i++) {
                TaskDto task = new TaskDto();
                task.setTaskType(1001);
                task.setPriority(1);
        ...
        System.out.println("Time Cost(ms) using pipeline: "+(System.currentTimeMillis()-start));
    }
}